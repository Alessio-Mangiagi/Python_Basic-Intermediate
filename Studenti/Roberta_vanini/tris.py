...
class Tris:
    def __init__(self, instanzaTkinter):
        ...
        # Configura le righe e colonne per espandersi proporzionalmente
        for i in range(3):
            self.instanzaTkinter.grid_rowconfigure(i, weight=2)
            self.instanzaTkinter.grid_columnconfigure(i, weight=2)
        ...
        for row in range(3):  # Per ogni riga (0, 1, 2)
            ...
            for col in range(3):  # Per ogni colonna (0, 1, 2)
                button = tk.Button(
                    ...
                    # width=5,  # RIMOSSO: Larghezza del pulsante
                    # height=2,  # RIMOSSO: Altezza del pulsante
