...
def on_motion(event):
    ...
    print(f"Mouse a: {event.x}, {event.y}")
...
text.grid(row=2, column=0, padx=10, pady=5)
...
btn.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
...
info_label.grid(row=4, column=0, sticky="nsew")
